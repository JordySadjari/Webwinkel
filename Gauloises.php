       ...
       <div class="container_12">
        ...
        <div id="nav" class="grid_12">
            <ul>
                ...
                <li><a href="Gauloises.php" class="sliding-middle-out active">Gauloises</a></li>
        ...
        <div id="producten" class="grid_12">
            <ul>
                <li class="product grid_6 alpha">
                    <div class="info">
                       <h2>$ 29,00</h2>
                        <p>Gauloises Blondes Blue<br>
                        Made in France (King Size Box)<br>
                        Tar 12 mg, Nicotine 0.9 mg</p><br>
                        <label>Aantal : </label><input type="number" value="0" class="selector">
                        <input type="button" value="Add to cart" class="Cart">
                    </div>
                <img src="Fotos/gauloises/gauloises-blondes-blue.png" alt="noImg">
                </li>
                
                <li class="product grid_6 omega">
                    <div class="info">
                       <h2>$ 29,00</h2>
                        <p>Gauloises Blondes Red<br>
                        Made in France (King Size Box)<br>
                        Tar 7 mg, Nicotine 0.7 mg</p><br>
                        <label>Aantal : </label><input type="number" value="0" class="selector">
                        <input type="button" value="Add to cart" class="Cart">
                    </div>
                <img src="Fotos/gauloises/gauloises-blondes-red.png" alt="noImg">
                </li>
                
                <li class="product grid_6 alpha">
                    <div class="info">
                       <h2>$ 29,00</h2>
                        <p>Gauloises Blondes Yellow<br>
                        Made in France (Hard Pack)<br>
                        Tar 4 mg, Nicotine 0.4 mg</p><br>
                        <label>Aantal : </label><input type="number" value="0" class="selector">
                        <input type="button" value="Add to cart" class="Cart">
                    </div>
                <img src="Fotos/gauloises/gauloises-blondes-yellow.png" alt="noImg">
                </li>
                ...
                <li class="product grid_6 omega">
                    <div class="info">
                        <p>
                        <h2>$ 29,00</h2>
                        <p>Gauloises Brunes Non Filter<br>
                        Made in France (Soft Pack)<br>
                        Tar 12 mg, Nicotine 0.7 mg</p><br>
                        <label>Aantal : </label><input type="number" value="0" class="selector">
                        <input type="button" value="Add to cart" class="Cart">
                    </div>
                <img src="Fotos/gauloises/gauloises-brunes-non-filter.png" alt="noImg">
                </li>
