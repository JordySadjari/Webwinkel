       ...
       <div class="container_12">
        ...
        <div id="nav" class="grid_12">
            <ul>
                ...
                <li><a href="Marlboro.php" class="sliding-middle-out active">Marlboro</a></li>
        ...
        <div id="producten" class="grid_12">
            <ul>
                ...
                <li class="product grid_6 alpha">
                    <div class="info">
                       <h2>$ 24,00</h2>
                        <p>Marlboro Black Menthol<br>
                        Made in Indonesia (King Size Box)<br>
                        Tar 8 mg, Nicotine 1.6 mg</p><br>
                ...
                <li class="product grid_6 omega">
                    <div class="info">
                       <h2>$ 30,00</h2>
                        <p>Marlboro Flavor Mix<br>
                        Made in Switzerland (King Size Box)<br>
                        Tar 8 mg, Nicotine 1.6 mg</p><br>
                        <label>Aantal : </label><input type="number" value="0" class="selector">
                        <input type="button" value="Add to cart" class="Cart">
                    </div>
                ...
                <li class="product grid_6 alpha">
                    <div class="info">
                        <h2>$ 30,00</h2>
                        <p>Marlboro Gold Original<br>
                        Made in Indonesia (King Size Box)<br>
                        Tar 9 mg, Nicotine 0.8 mg</p><br>
                        <label>Aantal : </label><input type="number" value="0" class="selector">
                        <input type="button" value="Add to cart" class="Cart">
                    </div>
                <img src="Fotos/Malboro/marlboro-gold-original.png">
                </li>
                
                <li class="product grid_6 omega">
                    <div class="info">
                       <h2>$ 24,00</h2>
                        <p>Marlboro Ice Blast<br>
                        Made in Indonesia (King Size Box)<br>
                        Tar 8 mg, Nicotine 0.6 mg</p><br>
                        <label>Aantal : </label><input type="number" value="0" class="selector">
                        <input type="button" value="Add to cart" class="Cart">
                    </div>
                <img src="Fotos/Malboro/marlboro-ice-blast.png">
                </li>
                ...
                <li class="product grid_6 alpha">
                    ...
                    <img src="Fotos/Malboro/marlboro-lights-gold.png">
                </li>
                
                <li class="product grid_6 omega">
                    <div class="info">
                       <h2>$ 24,00</h2>
                        <p>Marlboro Green Menthol<br>
                        Made in Indonesia (King Size Box)<br>
                        Tar 10 mg, Nicotine 0.8 mg</p><br>
                        <label>Aantal : </label><input type="number" value="0" class="selector">
                        <input type="button" value="Add to cart" class="Cart">
                    </div>
                <img src="Fotos/Malboro/marlboro-lights-menthol.png">
                </li>
                ...
                <li class="product grid_6 alpha">
                    <div class="info">
                       <h2>$ 29,00</h2>
                        <p>Marlboro Red<br>
                        Made in Indonesia (King Size Box)<br>
                        Tar 9 mg, Nicotine 0.7 mg</p><br>
                        <label>Aantal : </label><input type="number" value="0" class="selector">
                        <input type="button" value="Add to cart" class="Cart">
                    </div>
                <img src="Fotos/Malboro/marlboro-red-i.png">
                </li>
                
                <li class="product grid_6 omega">
                    <div class="info">
                       <h2>$ 29,00</h2>
                        <p>Marlboro Red Soft<br>
                        Made in Switzerland (Soft Pack)<br>
                        Tar 10 mg, Nicotine 0.8 mg</p><br>
                        <label>Aantal : </label><input type="number" value="0" class="selector">
                        <input type="button" value="Add to cart" class="Cart">
                    </div>
                <img src="Fotos/Malboro/marlboro-red-soft-s.png">
                </li>
                
                <li class="product grid_6 alpha">
                    <div class="info">
                       <h2>$ 29,00</h2>
                        <p>Marlboro Silver<br>
                        Made in Switzerland (King Size Box)<br>
                        Tar 4 mg, Nicotine 0.4 mg</p><br>
                        <label>Aantal : </label><input type="number" value="0" class="selector">
                    <input type="button" value="Add to cart" class="Cart">
                    </div>
                <img src="Fotos/Malboro/marlboro-silver-pack.png">
                </li>
            </ul>
        </div>
