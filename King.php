       ...
       <div class="container_12">
        ...
        <div id="nav" class="grid_12">
            <ul>
                ...
                <li><a href="King.php" class="sliding-middle-out active">King</a></li>
        ...
        <div id="producten" class="grid_12">
            <ul>
                ...
                <img src="Fotos/King/king-gold.png">
                </li>
                ...
                <li class="product grid_6 omega">
                    <div class="info">
                       <h2>$ 29,00</h2>
                        <p>King's Menthol<br>
                        Made in EU (King Size Box)<br>
                        Tar 10 mg, Nicotine 0.9 mg</p><br>
                        <label>Aantal : </label><input type="number" value="0" class="selector">
                        <input type="button" value="Add to cart" class="Cart">
                    </div>
                <img src="Fotos/King/king-menthol.png">
                </li>
                ...
                <li class="product grid_6 alpha">
                    <div class="info">
                       <h2>$ 29,00</h2>
                        <p>King's Silver<br>
                        Made in EU (King Size Box)<br>
                        Tar 8 mg, Nicotine 0.7 mg</p><br>
                        <label>Aantal : </label><input type="number" value="0" class="selector">
                        <input type="button" value="Add to cart" class="Cart">
                    </div>
                <img src="Fotos/King/king-silver.png">
                </li>
